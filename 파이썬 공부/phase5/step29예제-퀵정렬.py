...
# j=0: arr[0]=3 < 7 → i++ (i=0), swap(0,0)
# [3, 6, 8, 10, 1, 2, 7]  # i=0 (3까지가 작은 영역)

# j=1: arr[1]=6 < 7 → i++ (i=1), swap(1,1) 
# [3, 6, 8, 10, 1, 2, 7]  # i=1 (3,6까지가 작은 영역)

# j=2: arr[2]=8 > 7 → 그냥 지나감
# j=3: arr[3]=10 > 7 → 그냥 지나감

# j=4: arr[4]=1 < 7 → i++ (i=2), swap(2,4)
# [3, 6, 1, 10, 8, 2, 7]  # i=2 (3,6,1까지가 작은 영역)

# j=5: arr[5]=2 < 7 → i++ (i=3), swap(3,5)  
# [3, 6, 1, 2, 8, 10, 7]  # i=3 (3,6,1,2까지가 작은 영역)
